...
def extract_artist_songs(artist, parser_for_soup):
    ...
    try:
        ...
        logging.warn("Exception occured while extracting song links for artist: ",
                     artist, " skipping this artist!")
...
# Extract songs from artists or csv files
def extract_songs(artists, songs_folder, redownload=False, parser_for_soup="lxml"):
    ...
    artists_dfs = []
    progress_bar = tqdm(total=len(artists),
